...
function AksesJalan({ keys, kirimDataKeInduk }) {
  ...
  return (
    <div className="mt-5 shadow p-2">
      <h1 className="text-xl font-bold mb-4">Alternatif Akses Jalan</h1>
            ...
            <div className="container mx-auto">
              <div className="overflow-x-auto">
                <table className="min-w-full bg-white border border-gray-300">
                  <thead>
                    <tr>
                      <th className="py-2 px-4 border-b">AKSES JALAN</th>
                      {keys.map((item, i) => (
